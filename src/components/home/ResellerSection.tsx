...
const ResellerSection: FC<ResellerSectionProps> = ({}) => {
  return (
    ...
    <div className="bg-white flex flex-row justify-center w-full">
      <div className="bg-white w-[301px] h-[667px] relative">
        <div className="absolute w-[297px] h-[324px] top-[19px] left-[4px]">
          <Image
            className="absolute w-[274px] h-[264px] top-[60px] left-[23px] object-cover"
            alt="Reseller image"
            src={resellerImage}
          />
          <p className="absolute w-[187px] top-0 left-0 [font-family:'Roboto-Bold',Helvetica] font-bold text-transparent text-[24px] text-center tracking-[0.12px] leading-[24.1px]">
            <span className="text-[#f8df00]">UNLOCK</span>
            <span className="text-stone-900">
              {" "}
              A LUCRATIVE BUSINESS OPPORTUNITY
          ...
          <p className="absolute w-[139px] top-[101px] left-[24px] [font-family:'Inter-Bold',Helvetica] font-bold text-stone-900 text-[8px] text-center tracking-[0] leading-[normal]">
            Become an Only-Wifi Reseller and Connect Your Community
          </p>
        </div>
        <p className="absolute w-[237px] top-[360px] left-[32px] [font-family:'Inter-Regular',Helvetica] font-normal text-stone-900 text-[10px] text-center tracking-[0] leading-[normal]">
          Are you ready to be a trailblazer in the digital revolution? Only-Wifi
          presents an exclusive reseller opportunity that allows you to connect
          your community while earning attractive commissions. <br />
          <br />
          Dive into our beta release phase and play a pivotal role in providing
          fast and reliable internet access to your neighborhood. Don&#39;t miss
          out on this chance to make a positive impact while boosting your
          income. <br />
          <br />
          Sign up now and be part of the future of connectivity!
        </p>
        <div className="absolute w-[115px] h-[30px] top-[555px] left-[94px]">
          <div className="relative w-[113px] h-[30px] bg-[#f8df00] rounded-[26px] shadow-[0px_1px_2px_1px_#00000040]">
            <div className="absolute w-[84px] top-[15px] left-[14px] [font-family:'Open_Sans-Bold',Helvetica] font-bold text-black text-[8px] text-center tracking-[0.10px] leading-[0.1px]">
              BECOME A RESELLER
            </div>
          </div>
        </div>
        <div className="absolute w-[301px] h-[56px] top-[611px] left-0">
          <div className="relative h-[56px]">
            <div className="absolute w-[301px] h-[56px] top-0 left-0 bg-stone-900 blur-sm">
              <div className="relative w-[113px] h-[56px] left-[94px] bg-[#383432] blur-sm" />
            </div>
            <div className="w-[74px] left-[113px] absolute h-[26px] top-[13px]">
              <p className="absolute w-[53px] top-0 left-[19px] [font-family:'Inter-Regular',Helvetica] font-normal text-transparent text-[6px] tracking-[0] leading-[normal]">
                <span className="text-white">
                  Empower Your Community with Internet Access
                </span>
              </p>
              <Image
                className="absolute w-[17px] h-[26px] top-0 left-0"
                alt="Ok"
                src={okImage}
              />
            </div>
            <div className="absolute w-[68px] h-[27px] top-[12px] left-[221px]">
              <p className="absolute w-[47px] top-[3px] left-[19px] [font-family:'Inter-Regular',Helvetica] font-normal text-transparent text-[6px] tracking-[0] leading-[normal]">
                <span className="text-white">
                  Easy Sign-Up Flexible Business Model - Part-time or Full-time
                </span>
              </p>
            ...
            <div className="w-[82px] left-[10px] absolute h-[26px] top-[13px]">
              <Image
                className="absolute w-[17px] h-[26px] top-0 left-0"
                alt="Ok"
                src={okImage}
              />
              <p className="absolute w-[60px] top-[4px] left-[20px] [font-family:'Inter-Regular',Helvetica] font-normal text-transparent text-[6px] tracking-[0] leading-[normal]">
                <span className="text-white">
                  Earn Commissions on Data Package Sales
                </span>
              </p>
